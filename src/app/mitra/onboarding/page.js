...
import { CheckCircle2, QrCode, TrendingUp, Users, Sparkles, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-gray-100 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[430px] h-full flex flex-col shadow-2xl overflow-y-auto" style={{
        ...
        <div className="flex flex-col items-center justify-center px-4 py-6 relative min-h-full">
          {/* Animated Background */}
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm mb-2" style={{
            ...
            Profil mitra Anda telah berhasil dibuat
          </p>
          {qrisStatus === 'belum' && (
            <div className="inline-block px-3 py-1.5 rounded-lg mt-2" style={{
              background: 'rgba(255, 200, 87, 0.15)',
              border: '2px solid rgba(255, 200, 87, 0.3)'
            }}>
              <p className="text-xs font-semibold" style={{ color: '#C89000' }}>
          ...
          <div className="space-y-3 relative z-10">
            {qrisStatus === 'belum' && (
              <div className="flex items-start gap-2.5">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{
                  ...
                  <QrCode className="w-4 h-4" style={{ color: '#FFC857' }} />
                </div>
                <div>
            ...
            <div className="flex items-start gap-2.5">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{
                ...
                <TrendingUp className="w-4 h-4" style={{ color: '#6379B9' }} />
              </div>
              <div>
                <h3 className="font-semibold text-sm mb-0.5" style={{ color: '#1B1B1E' }}>
                  Omzet Naik +75%
            ...
            <div className="flex items-start gap-2.5">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{
                ...
                <Sparkles className="w-4 h-4" style={{ color: '#FFC857' }} />
              </div>
              <div>
                <h3 className="font-semibold text-sm mb-0.5" style={{ color: '#1B1B1E' }}>
        ...
        >
          ...
          <span className="relative z-10">Mulai Perjalanan Bisnis</span>
        </button>
      </div>
